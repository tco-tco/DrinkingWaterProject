...
path="C:/Users/tugbacanan.oguz/Desktop/YÖNETMELİK PARAMETRELER.xlsx"
sheet="Sayfa1"
pathgelen="C:/Users/tugbacanan.oguz/Desktop/param.xlsx"
sheetgelen="Sayfa1"
...
for i in gelenListe:
    if i in formatListe:
        ...
        workbook=openpyxl.load_workbook("C:\\Users\\tugbacanan.oguz\\Desktop\\param.xlsx")

        sheet1=workbook["Sayfa1"]
        sheet1.cell(row=indexGelen+1,column=2, value=indexFormat)
        workbook.save("C:\\Users\\tugbacanan.oguz\\Desktop\\param.xlsx") 
